# Generated by Django 4.1.3 on 2023-02-18 22:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('long_description', tinymce.models.HTMLField(max_length=2000)),
                ('created_on', models.DateTimeField(auto_now_add=True)),
                ('updated_on', models.DateTimeField(auto_now=True)),
                ('discord', models.CharField(max_length=50)),
                ('tiktok', models.CharField(blank=True, default='', max_length=50)),
                ('status', models.IntegerField(choices=[(0, 'Draft'), (1, 'Published')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(0, 'Unapproved'), (1, 'Approved'), (2, 'Rejected'), (3, 'Rejected and User banned')], default=0)),
                ('date_added', models.DateField(auto_now_add=True)),
                ('expiry', models.DateField(blank=True, null=True)),
                ('listing', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='website.serverlisting')),
                ('reviewed_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='user_approved', to=settings.AUTH_USER_MODEL)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_uploaded', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='game',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date_added', models.DateField(auto_now_add=True)),
                ('expiry', models.DateField(default=datetime.date(2023, 2, 19))),
                ('listing', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='website.serverlisting')),
