# Generated by Django 4.1.3 on 2023-01-29 00:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(0, 'Draft'), (1, 'Published')], default=0)),
                ('bumps', models.ManyToManyField(blank=True, related_name='server_bumps', to=settings.AUTH_USER_MODEL)),
                ('game', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='server_listings', to='website.game')),
